...
//			CONNECTION = properties.getProperty("messagingservice.TextMessageBean.conString");
...
//			properties.put("conTutelaString",CONNECTIONTUTELA);
			properties.put("conString",MYSQLDATABASE);
...
//		}
		...
		public Connection getConnectionMQSQLDB() throws SQLException{
			try {
				return DriverManager.getConnection(MYSQLDATABASE,DATABASEUSERNAME,DATABASEPASSWORD);
			}catch (SQLException e) {
						e.printStackTrace();
						throw new SQLException() ;
					}

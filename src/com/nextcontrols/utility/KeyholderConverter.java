...
import com.nextcontrols.pagebeans.KeyholdersPageBean;

@FacesConverter(value="keyholderconverter")
public class KeyholderConverter implements javax.faces.convert.Converter{

	@Override
	public Object getAsObject(FacesContext arg0, UIComponent arg1, String arg2) {
		FacesContext ctx= FacesContext.getCurrentInstance();
		Map<String,Object> sessionMap = ctx.getExternalContext().getSessionMap();
		KeyholdersPageBean keyholderBean = (KeyholdersPageBean) sessionMap.get("keyholders");
//		System.out.println("converter get as object called");
		...
		Keyholder source=KeyholderDAO.getInstance().getKeyholderById(
				keyholderBean.getSelectedDepartment().getBranch_code(), keyholderBean.getSelectedList().getKeyholderListId(),number);

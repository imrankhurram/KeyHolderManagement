...
public class DeleteCallListTest extends TestCase {
  ...
  @Test
  public void testDeleteCallList() throws Exception {
...
//    driver.findElement(By.xpath("//a[@onclick=\"mojarra.jsfcljs(document.getElementById('frmquotationPage'),{'frmquotationPage:tbDepartmentList:1:j_idt31':'frmquotationPage:tbDepartmentList:1:j_idt31'},'');return false\"]")).click();
	...
	By element = By.id("tbKeyholderCallList:0:deleteCallList");
...
//			
		...
		element = By.id("tbKeyholderCallList:" + i + ":deleteCallList");
		i++;
	...
	if (!"".equals(buttonName)) {
		...
		while (count < 4) {
			try {
				driver.findElement(By.id("deleteCallListBtn")).click();
